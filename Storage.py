...
class Storage:
    def __init__(self):
        ...
        self.playerAnimationFrames = [4, 6, 3, 1, 2, 4, 6, 3, 1, 2, 3, 6, 2, 3, 1, 7, 7]
        self.playerFrameSize = (57, 57)
        self.rubinEnemySpriteSheet = 'Images/ENEMY_FRAMES/spritesheet.png'
        self.rubinEnemyAnimationFrames = [6, 4, 3, 4, 5]
        ...
        self.staticBackgroundSpritesheet = 'Images/Levels/Level1/LEVEL_1/BACKGROUND.png'
        self.staticBackgroundSize = (569, 320)
        self.dinamicBackgroundSpritesheet = 'Images/Levels/Level1/LEVEL_1/spritesheet (3).png'
        self.dinamicBackgroundSize = (1138, 320)
        self.dinamicBackgroundAnimationFrames = [1, 1, 1]
        self.groundSpritesheet = 'Images/Levels/Level1/LEVEL_1/GROUND_2_FLAT.png'
        self.playerSpritesheet = 'Images/ALIEN_FRAMES/spritesheet.png'
        self.guardianSpritesheet = 'Images/Levels/Level1/LEVEL_1/guardian.png'
